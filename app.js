...
const photoDisplayFix = document.createElement('style');
photoDisplayFix.textContent = `
  .memory-card img { object-fit: contain !important; background: #fff4f7; }
  .photo-arch img { object-fit: contain !important; background: #fff3f7; }
  .reveal-photo { width: 126px !important; height: 142px !important; object-fit: contain !important; background: #fff4ef; border-radius: 23px !important; }
`;
document.head.append(photoDisplayFix);
